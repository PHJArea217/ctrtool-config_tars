...
"$REPO_ROOT/ctrtool-config_tars/u-relay-portable/setup_u-relay-main.sh"
...
"$REPO_ROOT/ctrtool-config_tars/u-relay-portable/dist2access.sh" br1 'fedb:1200:4500:7811::1/64'
